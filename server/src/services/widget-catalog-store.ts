...
const BUILTIN_WIDGETS = [
  ...
  },
  {
    ...
    icon: 'Lightbulb',
    color: '#d97706',
    description: '基于驾驶舱上下文、审批信息、日程、行业数据和用户上下文生成通用洞察、证据链和行动建议。',
    agentDescription: '当用户需要跨组件、跨上下文形成风险、机会、异常、建议或洞察报告时，优先选择 business 洞察中心组件。该组件可读取当前驾驶舱上下文，并通过 YonClaw、OpenAPI 或后端 insight executor 生成结果。',
    useCases: ['经营洞察', '风险识别', '机会建议', '审批联动分析'],
    tags: ['business', 'insight', 'context', 'recommendation'],
    schemaHint: {
      recommendedDataShape: {
        businessType: 'insight-hub',
        insights: 'Array<{ id,title,type,severity,summary,evidence,recommendation,confidence,actions }>',
      },
      layoutAdvice: '建议 w=6、h=5；适合放在首屏或报告区旁边，可与消息中心、日程组件联动。',
      styleConfig: {
    ...
    template: {
      ...
      business: {
        category: 'business',
        businessType: 'insight-hub',
        dataContract: 'business-insights.v1',
